...
\author{Aashna Sahu\\ EE23BTECH11001}
\date{}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/a.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
    https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/gain_LP.py
\end{lstlisting}
...
\begin{lstlisting}
     https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/exp_calc.py
\end{lstlisting}
\begin{align}
...
\begin{lstlisting}
   https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/b.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
   https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/g.py
\end{lstlisting}
...
The below code plots the Band Pass Filter plot\\
\begin{lstlisting}
  https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/c.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
    H_{d,BP}(z) &= \frac{G\brak{1 - 4z^{-2} + 6z^{-4} - 4z^{-6} + z^{-8}}}{1.7508-10.6494*z^{-1} + 30.978z^{-2} - 55.158z^{-3} + 65.43z^{-4} -52.814z^{-5} + 28.4z^{-6} - 9.349z^{-7} + 1.472z^{-8}}
\end{align}

where $G=1.908\times 10^{-5}$  
\begin{lstlisting}
     https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/filter_in_z.py
\end{lstlisting}  
The below code plots the Digital Band Pass Filter plot\\
\begin{lstlisting}
   https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/f.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
      https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/FIR_1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
     https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/d.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
    https://github.com/aashnasahu24/Signals_and_systems/blob/main/Filter_Design/codes/e.py
\end{lstlisting}
\begin{figure}[H]
\centering
