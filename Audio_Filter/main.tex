...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11005 - Aashna Sahu$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/soundfile.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6.1.py 
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{3.627}y(n - 1) + \brak{4.95}y(n - 2) \nonumber \\
	&- \brak{3.012}y(n - 3) + \brak{0.689}y(n - 4) \nonumber \\
	&= \brak{2.15\times 10^{-5}}x(n) + \brak{8.608 \times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{1.29 \times 10^{-4}}x(n - 2) + \brak{8.608 \times 10^{-5}}x(n - 3) \nonumber \\
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/aashnasahu24/Signals_and_systems/blob/main/Audio_Filter/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
